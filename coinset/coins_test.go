...
import (
	...
	"github.com/nicholas-mwaura/twhutil/coinset"
)

type TestCoin struct {
	TxHash     *chainhash.Hash
	TxIndex    uint32
	TxValue    twhutil.Amount
	TxNumConfs int64
}

func (c *TestCoin) Hash() *chainhash.Hash { return c.TxHash }
func (c *TestCoin) Index() uint32         { return c.TxIndex }
func (c *TestCoin) Value() twhutil.Amount { return c.TxValue }
...
func NewCoin(index int64, value twhutil.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	...
	testSimpleCoinTxValue0            = twhutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = twhutil.NewTxFromBytes(testSimpleCoinTxBytes)
