...
/*
This test file is part of the twhutil package rather than than the
twhutil_test package so it can bridge access to the internals to properly test
...
import (
	...
	"github.com/nicholas-mwaura/twhutil/bech32"
