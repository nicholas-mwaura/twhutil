...
// Tx returns a wrapped transaction (twhutil.Tx) for the transaction at the
...
// Transactions returns a slice of wrapped transactions (twhutil.Tx) for all
...
// instead provides easy access to wrapped versions (twhutil.Tx) of them.
